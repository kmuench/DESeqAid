...
addHUGOnames <- function(my_df, whichEnsembl, transcript_or_gene){
  ...
  genemap <- getBM( attributes = c("ensembl_gene_id", "entrezgene","external_gene_name"), # c("ensembl_gene_id", "entrezgene","external_gene_name") OR c("ensembl_transcript_id", "ensembl_gene_id", "entrezgene", "hgnc_symbol") 
